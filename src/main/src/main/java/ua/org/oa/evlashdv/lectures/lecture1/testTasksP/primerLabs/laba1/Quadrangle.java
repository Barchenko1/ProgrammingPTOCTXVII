package ua.org.oa.evlashdv.lectures.lecture1.testTasksP.primerLabs.laba1;
...
public class Quadrangle extends Figura {
    ...
    public void print() {
        ...
        double perimeter = 0;
        perimeter += countSizeSide(points[0], points[NUMBER - 1]);
        for (int i = 0; i < NUMBER - 1; i++) {
            perimeter += countSizeSide(points[i], points[i + 1]);
        }
