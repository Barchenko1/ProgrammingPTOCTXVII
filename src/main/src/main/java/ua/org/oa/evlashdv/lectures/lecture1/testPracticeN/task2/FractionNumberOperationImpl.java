...
public class FractionNumberOperationImpl implements FractionNumberOperation {
    ...
    public FractionNumber add(FractionNumber fractionNumber1, FractionNumber fractionNumber2) {
        ...
        int a=fractionNumber1.getDivisor();
        int b=fractionNumber2.getDivisor();
        ...
        int chislitet2=(lcmNumber/fractionNumber2.getDivisor())*fractionNumber2.getDividend();
        int sumChislitel=chislitet1+chislitet2;
